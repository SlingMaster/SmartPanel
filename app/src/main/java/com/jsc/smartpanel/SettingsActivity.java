...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (preference.getKey().equals("device_ip")) {
                    stringValue = ipStr;
                }
                preference.setSummary(stringValue);
            }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // ------------------------------------------------
            bindPreferenceSummaryToValue(findPreference("ip_weather"));
    ...
    public static class AdvancedPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(true);
            // ------------------------------------------------
            bindPreferenceSummaryToValue(findPreference("link_list"));
        }
    ...
    public static class SchedulePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(true);
            // ------------------------------------------------
            bindPreferenceSummaryToValue(findPreference("start_day"));
            bindPreferenceSummaryToValue(findPreference("start_night"));
            bindPreferenceSummaryToValue(findPreference("swap_frequency"));
        }
